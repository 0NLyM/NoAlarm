...
**Ultima revisione**: v1.4.27 (17 Sep 2026) — prova reale su TicWatch E3: il bridging di sistema (v1.4.26) non fa arrivare la notifica al watch. Aggiunto "Prova la sveglia adesso" in Impostazioni (sveglia sintetica `AlarmScheduler.TEST_ID`) per iterare sul debug senza aspettare l'orario, e documentata l'ipotesi piu' probabile (permesso "Accesso alle notifiche" mancante per Mobvoi Health) in "Eco sul Watch via Notification Bridging di Sistema".
