...
/**
 * Fa suonare/spegnere l'eco sul watch WearOS abbinato via Data Layer API, quando c'e'.
 * Se il watch non e' raggiungibile in quel momento (o non risulta come "nodo",
 * es. con alcuni companion di terze parti) non succede nulla: e' solo un'eco
 * in piu' al polso, non la fonte di verita' della sveglia (quella resta sempre
 * AlarmService/AlarmManager sul telefono).
 */
object WearBridge {
